  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="text-zinc-400 text-sm mb-8">Join Refalo and share your referral codes</p>

        <button
          type="button"
          onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
          className="w-full flex items-center justify-center gap-3 border border-zinc-700 hover:border-zinc-500 text-zinc-300 hover:text-white bg-zinc-900 hover:bg-zinc-800 py-2.5 rounded-lg text-sm font-medium transition-colors mb-6"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <label className="flex items-center gap-2.5 cursor-pointer">
            ...
            />
            <span className="text-xs text-zinc-400">Send me weekly referral deals &amp; new brands</span>
          </label>
